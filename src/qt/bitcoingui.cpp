...
//    this->setStyleSheet("background-color: qradialgradient(spread:pad, cx:0.29, cy:0.23, radius:1, fx:0.29, fy:0.23,  stop:0 #44505e, stop:1#262d35);");
    GUIUtil::restoreWindowGeometry("nWindow", QSize(1178, 810), this);
    this->setMinimumWidth(1178);
    this->setMinimumHeight(810);
    ...
    if (enableWallet) {
        ...
        walletFrame->setStyleSheet("background-color: blue");
    ...
    QFontDatabase::addApplicationFont(":/fonts/res/fonts/Chapaza.ttf");
    QFontDatabase::addApplicationFont(":/fonts/res/fonts/Chivo.ttf");
    QString karlaFontName = QFontDatabase::applicationFontFamilies(fontId).at(0);
    QFont font(karlaFontName, 12);
    font.setStyleHint(QFont::Monospace);
    QFontDatabase::addApplicationFont(":/fonts/res/fonts/Snacker.ttf");
...
//    QApplication::setStyle(new Style_tweaks);
    ...
    QFrame* frameBlocks = new QFrame();
       ...
       lockButton->setMaximumHeight(24);
       lockButton->setMinimumHeight(24);
       lockButton->setIcon(QPixmap(":/icons/res/icons/lock.png"));
       lockButton->setIconSize(QSize(24, 24));
       lockButton->setMinimumWidth(24);
       lockButton->setMaximumWidth(24);
       refreshButton = new QPushButton();
       refreshButton->setStyleSheet("background-color: transparent;");
       refreshButton->setMaximumHeight(24);
       refreshButton->setMinimumHeight(24);
       refreshButton->setIcon(QPixmap(":/icons/res/icons/refresh.png"));
       refreshButton->setIconSize(QSize(24, 24));
       refreshButton->setMinimumWidth(24);
       refreshButton->setMaximumWidth(24);
       refreshButton->setFlat(true);
       networkButton = new QPushButton();
       networkButton->setStyleSheet("background-color: transparent");
       networkButton->setMaximumHeight(24);
       networkButton->setMinimumHeight(24);
       networkButton->setIcon(QPixmap(":/icons/res/icons/network.png"));
       networkButton->setIconSize(QSize(24, 24));
       networkButton->setMinimumWidth(24);
       networkButton->setMaximumWidth(24);
       networkButton->setFlat(true);

       upButton = new QPushButton();
       upButton->setStyleSheet("background-color: transparent");
       upButton->setMaximumHeight(24);
       upButton->setMinimumHeight(24);
       upButton->setIcon(QPixmap(":/icons/res/icons/up.png"));
       upButton->setIconSize(QSize(24, 24));
       upButton->setMinimumWidth(24);
       upButton->setMaximumWidth(24);
       upButton->setFlat(true);
        ...
        progressBarLabel->setStyleSheet("background-color: transparent; color: #5e6972; margin-left: 18px");
        progressBarLabel->setVisible(true);
        progressBar = new GUIUtil::ProgressBar();
        progressBar->setAlignment(Qt::AlignCenter);
        progressBar->setStyleSheet("background-color: transparent; color: #5e6972; font-weight: bold;");
        ...
        emptyWidget->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Preferred);
        emptyWidget->setMinimumWidth(10);
        emptyWidget->setMaximumWidth(10);
        emptyWidget->setStyleSheet("background-color: transparent");
//        emptyWidget->hide();
        statusBar()->setStyleSheet("background-color: transparent; height: 50;");
...
//        statusBar()->addPermanentWidget(frameBlocks);
        ...
        statusBar()->addPermanentWidget(lockButton);
        statusBar()->addPermanentWidget(upButton);
        statusBar()->addPermanentWidget(networkButton);
        statusBar()->addPermanentWidget(refreshButton);
        statusBar()->addPermanentWidget(emptyWidget);
    ...
    connect(lockButton,  SIGNAL(clicked()), walletFrame, SLOT(toggleLockWallet()));
...
//    tabButtonGroup->addButton(mnsButton);
    ...
    connect(mnsButton, SIGNAL(clicked ()), this, SLOT(gotoMasternodePage()));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        toolbar->setStyleSheet("background-color: transparent; border-color: transparent");
...
//        toolbar->addAction(overviewAction);
        ...
        spacing1->setStyleSheet("background-color: transparent");
        spacing1->setMinimumWidth(22);
        spacing1->setMaximumWidth(22);
        spacing1->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Preferred);
        toolbar->addWidget(spacing1);

        toolbar->addWidget(sendCoinsButton);
        QWidget *spacing2 = new QWidget();
        spacing2->setStyleSheet("background-color: transparent");
        spacing2->setMinimumWidth(22);
        spacing2->setMaximumWidth(22);
        spacing2->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Preferred);
        toolbar->addWidget(spacing2);
        toolbar->addWidget(receiveButton);
        QWidget *spacing3 = new QWidget();
        spacing3->setStyleSheet("background-color: transparent");
        spacing3->setMinimumWidth(22);
        spacing3->setMaximumWidth(22);
        spacing3->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Preferred);
        toolbar->addWidget(spacing3);
        toolbar->addWidget(mnsButton);
        QWidget *spacing4 = new QWidget();
        spacing4->setStyleSheet("background-color: transparent");
        spacing4->setMinimumWidth(22);
        spacing4->setMaximumWidth(22);
        spacing4->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Preferred);
        toolbar->addWidget(spacing4);
...
//        if (settings.value("fShowMasternodesTab").toBool()) {
//            QWidget *spacing5 = new QWidget();
//            spacing5->setStyleSheet("background-color: transparent");
//            spacing5->setMinimumWidth(22);
//            spacing5->setMaximumWidth(22);
//            spacing5->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Preferred);
//            toolbar->addWidget(spacing5);
...
//        layout->addWidget(toolbar);
        walletFrame->setStyleSheet("background-color: transparent");
