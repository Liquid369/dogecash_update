                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received DogeCash from zDogeCash"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDogeCash"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDogeCash));
...
// Cover scroll bar width with spacing
    ...
    view->setStyleSheet("background-color: transparent; QHeaderView::section {border-right: 1px solid 4181C0; background:#1f272e; color: #b99d7c;}" );
