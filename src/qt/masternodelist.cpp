                                                  ...
                                                  walletModel(0)
{
    ...
    ui->tableWidgetMyMasternodes->setFont(*font_table);
    ui->autoupdate_label->setFont(*font_table);
    ui->secondsLabel->setFont(*font_table);
    ui->label_sec->setFont(*font_table);

    ui->startButton->setFont(*font_button);
    ui->startAllButton->setFont(*font_button);
    ui->startMissingButton->setFont(*font_button);
    ui->UpdateButton->setFont(*font_button);
...
void MasternodeList::setFont()
{
    font_table = new QFont();
    font_table->setFamily("Chivo");
    font_table->setPixelSize(13);
    font_table->setLetterSpacing(QFont::AbsoluteSpacing, 1.2);

    font_button = new QFont();
    font_button->setFamily("Chivo");
    font_button->setPixelSize(15);
    font_button->setLetterSpacing(QFont::AbsoluteSpacing, 1.4);
