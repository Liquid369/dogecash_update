...
//    walletStack->hide();
    walletStack->setStyleSheet("background-color: transparent;");

    QLabel* noWallet = new QLabel(tr("No wallet has been loaded."));
    noWallet->setAlignment(Qt::AlignCenter);
    walletStack->addWidget(noWallet);
    noWallet->setStyleSheet("background-color: transparent");
}
...
bool WalletFrame::addWallet(const QString& name, WalletModel* walletModel)
{
    ...
    walletView->setStyleSheet("background-color: transparent");
...
void WalletFrame::gotoOverviewPage()
{
    ...
    for (i = mapWalletViews.constBegin(); i != mapWalletViews.constEnd(); ++i)
    {
        i.value()->setStyleSheet("background-color: transparent");
